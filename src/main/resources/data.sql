...
VALUES (null, 'Admin Test', 'test@unlam.edu.ar', 'test', 'ADMIN', true),
       ...
       (null, 'Juan', 'juan@unlam.com', 'test', 'USER', true),
       (null, 'Marcos', 'marcos@unlam.com', 'test', 'USER', true),
       (null, 'Sofia', 'sofia@unlam.com', 'test', 'USER', true),
       (null, 'Valentina', 'valentina@unlam.com', 'test', 'USER', true);

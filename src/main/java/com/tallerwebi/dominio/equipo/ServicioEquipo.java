...
public interface ServicioEquipo {
    ...
    void agregarJugadorAlEquipo(Long idEquipo, Long idJugador, Integer numeroDeOrden) throws EquipoNoEncontradoException, PresupuestoInsuficienteException, elJugadorYaExisteEnElEquipoException, FechaNoEncontradaException, NoSePuedeModificarEquipoSiLaFechaEstaEnCursoException;

    void eliminarJugadorDelEquipo(Long idEquipo, Long idJugador) throws EquipoNoEncontradoException, FechaNoEncontradaException, NoSePuedeModificarEquipoSiLaFechaEstaEnCursoException;
    ...
    void validarEquipoCompleto(Long idEquipo) throws EquipoSinCompletarException, FechaNoEncontradaException;
    ...
    void copiarEquiposDeUnaFechaAOtra(Fecha fechaAnterior, Fecha fechaNueva);
}

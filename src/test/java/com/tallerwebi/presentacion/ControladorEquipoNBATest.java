...
public class ControladorEquipoNBATest {
    ...
    public void inicializacion() {
        ...
        controladorEquipoNBA =
                new ControladorEquipoNBA(
                        servicioEquipoNBAMock,
                        servicioEquipoNBAJugadorMock,
                        servicioTorneoMock
                );
    }
    ...
    public void alGuardarEquipoTeRedirigeAAsignarJugadores() {
        ...
        assertThat(
                mav.getViewName(),
                equalToIgnoringCase("redirect:/admin/asignar-jugadoresNBA/1")
        );
    }
    ...
    public void asignarJugadoresDeberiaRetornarLaVistaConLosDatosDelEquipo() throws EquipoNoEncontradoException {
        ...
        when(servicioEquipoNBAJugadorMock.obtenerJugadoresFiltrados(null, null))
                .thenReturn(jugadoresDisponibles);
        when(servicioEquipoNBAJugadorMock.obtenerJugadoresDelEquipoPorId(idEquipo))
                .thenReturn(jugadoresEquipo);

        ModelAndView mav =
                controladorEquipoNBA.asignarJugadores(idEquipo, null, null, null);
    ...
    public void agregarJugadoresAlEquipoNBATeRedirigeALaMismaVista()
            throws elJugadorYaExisteEnElEquipoException, EquipoNoEncontradoException {

        Long idEquipo = 1L;
        Long idJugador = 2L;

        ModelAndView mav =
                controladorEquipoNBA.agregarJugadorAlEquipo(idEquipo, idJugador);
    ...
    public void eliminarJugadorDelEquipoNBATeRedirigeAMismaVista() throws EquipoNoEncontradoException {
        ...
        ModelAndView mav =
                controladorEquipoNBA.quitarJugadorAEquipoNBA(idEquipo, idJugador);
    ...
    public void queSePuedaVerElListadoDeEquiposNBA() {
        ...
        when(servicioEquipoNBAMock.obtenerTodosLosEquiposOrdenadosDeMenorAMayor())
                .thenReturn(equipos);

        ModelAndView mav =
                controladorEquipoNBA.verListadoDeEquiposNBA(null);
    ...
    public void queSePuedaVerElDetalleDeUnEquipoNBA() throws EquipoNoEncontradoException {
        ...
        ModelAndView mav =
                controladorEquipoNBA.verDetalleEquipoNBA(idEquipo);
